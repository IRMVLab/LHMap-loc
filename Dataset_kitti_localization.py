...
class DatasetVisibilityKittiSingle(Dataset):
    ...
    def __init__(self, dataset_dir, transform=None, augmentation=False, maps_folder='local_maps',
        ...
        for dir in ['00', '03', '05', '06', '07', '08', '09']:
            ...
            for index, row in df_locations.iterrows():
                if not os.path.exists(os.path.join(dataset_dir, dir, 'pcl', str(row['timestamp'])+'.npy')):
                    continue
    ...
    def __getitem__(self, idx):
        ...
        pc_path = os.path.join('./KITTI_ODOMETRY/hLidar', run, 'pcl', timestamp+'.npy')
        ...
        if self.split == 'train':
            ...
            pc_in = utils.rotate_forward(pc_in, R, T)
